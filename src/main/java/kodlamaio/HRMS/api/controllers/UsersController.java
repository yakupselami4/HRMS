...
public class UsersController {
	...
	@GetMapping("/getByHighSchoolAndUniversity")
	public DataResult<CurriculumVitae> getByHighSchoolAndUniversity(String highSchool, String university){
		return new SuccessDataResult<CurriculumVitae>(this.cvdao.getByHighSchoolAndUniversity(highSchool, university),"Eğitim bilgileri sisteme kaydedildi.");
	}
	@GetMapping("/getByLanguageAndAbilities")
	...
	@GetMapping("/getByGithubAddressAndLinkedInAddress")
	public DataResult<CurriculumVitae> getByGithubAddressAndLinkedInAddress(String githubAddress,String linkedInAddress){
